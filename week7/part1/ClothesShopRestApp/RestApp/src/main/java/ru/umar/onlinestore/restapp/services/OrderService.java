...
public class OrderService {
    ...
    @Transactional
    public ResponseEntity<String> save(int t_shirt_id, int buyer_id, String order_date){
        ...
        if(t_shirt.isEmpty() || buyer.isEmpty())
            return new ResponseEntity<>("T_Shirt or Buyer wasn't found!", HttpStatus.BAD_REQUEST);
